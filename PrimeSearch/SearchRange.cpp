...
void SearchRange::searchPrimes(unsigned long int start, unsigned long int end, unsigned int threadId, APrint* printer, std::atomic<bool>& isPrimeFlag)
{
...
bool SearchRange::isPrime(unsigned long int number)
{
